					...
					[
						{
							// Display Main Title
							content: "To Dos",
							style: "opacity:0.2;text-rendering: optimizeLegibility;text-shadow: -1px -1px rgba(0, 0, 0, 0.2);font-color:rgba(255, 255, 255, 0.3);font-weight:bold;font-size:50px;text-align:center;margin-top:20px;margin-bottom:20px;"
							// Original:  style: "opacity:0.2;text-rendering: optimizeLegibility;text-shadow: -1px -1px rgba(0, 0, 0, 0.2);font-color:rgba(255, 255, 255, 0.3);font-weight:bold;font-size:70px;text-align:center;margin-top:20px;margin-bottom:20px;"
						},
						{
							// Display Top Border
							kind: "FittableRows",
