...
enyo.kind({
	...
	handlers: {
		// Disable Handlers 
		// since not supported on a physical device (only works in browsers)
	...
	[{
		...
		[
...

			{
				...
				ontap: "itemComplete",
				style: "font-size: 20px;padding-top: 16px;width:50px;height:inherit;background-color:inherit;text-align:center;"
			},
			{
				name: "userTodoString",
				content: "",
				...
				classes: "task-format",
				style: "border:0px;border-left: 1px solid red;margin:0px;height:inherit;background-color:inherit;padding:15px;"
			},
			{
				content: '✖',
				...
				style: "visibility:visible;font-size: 22px;padding-top: 16px;width:50px;height:inherit;background-color:inherit;text-align:center;"
...
enyo.kind({
	...
	[{
		...
		[
			...
			{
				// Display Buttom Margin (i.e. a Spacer)
				kind: "FittableRows",
				style: "height:50px;"
			}
		]
