...
enyo.path.addPaths({layout: "/Users/troy/Documents/troywork/Edutraining/Enyo/TroyMVC/bootplate_5/enyo/../lib/layout/", onyx: "/Users/troy/Documents/troywork/Edutraining/Enyo/TroyMVC/bootplate_5/enyo/../lib/onyx/", onyx: "/Users/troy/Documents/troywork/Edutraining/Enyo/TroyMVC/bootplate_5/enyo/../lib/onyx/source/"});
...
return this.parentsThisVar = this.parentsThis, !0;
},
...
itemDeleteWithBind: function(e, t) {
return this.localDeleteActionItemVar.deleteThisActionItemReference(this.getName()), !0;
},
onMouseOver: function(e, t) {
return this.$.userTodoDeleteMark.applyStyle("visibility", "visible"), !0;
},
...
deleteActionItem: function(t) {
if (this.$.listOfItems.controls.length > 0) {
var n = this.getComponents();
for (var r = 0; r < n.length; r++) n[r].getName() == t && n[r].destroy();
}
return !0;
}
});
