...
enyo.kind({
	...
	itemDelete: function(inSender, inEvent) {
		...
		// enyo.log("this.parentsThis.id = " + this.parentsThis.id);

		// enyo.log("1 - index = " + this.parentThis.indexOfChild(this.node));
		// enyo.log("2 - index = " + this.parentThis.indexOfControl(this.hasNode()));

		// this.parentsThis.destroyObject(this.id);
		// this.parentsThis.render();
		...
		// this.parentsThis.controls[3].controls[this.index] = null;
		// this.parentsThis.controls[3].render();

		// this.parentsThis.controls[3].controls[this.index] = null;
		// this.parentsThis.controls[3].controls[this.index].destroy();
		// this.parentsThis.$.listOfItems.render();
