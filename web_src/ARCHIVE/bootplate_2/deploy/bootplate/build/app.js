...
enyo.path.addPaths({layout: "/Users/troy/Documents/troywork/Edutraining/TroyMVC/bootplate/enyo/../lib/layout/", onyx: "/Users/troy/Documents/troywork/Edutraining/TroyMVC/bootplate/enyo/../lib/onyx/", onyx: "/Users/troy/Documents/troywork/Edutraining/TroyMVC/bootplate/enyo/../lib/onyx/source/"});
...
components: [ {
content: "ToDos",
style: "font-size:30px;text-align:center;margin-top:20px;margin-bottom:20px;"
}, {
kind: "FittableRows",
style: "width:548px;height:15px;margin:auto;background-color:rgba(101, 84, 76, 0.8);"
}, {
name: "createTodoItem",
kind: "FittableRows",
style: "width:548px;height:65px;margin:auto;background-color:green;",
components: [ {
...
name: "displayTodoItem_1",
kind: "FittableRows",
style: "width:548px;height:59px;margin:auto;background-color:green;border-bottom: 1px dotted #ccc;",
components: [ {
kind: "FittableColumns",
style: "height:100%;",
components: [ {
content: "\u2714",
name: "secondEntry_1_checkmark",
ontap: "itemComplete",
style: "padding-top: 16px;width:50px;height:inherit;background-color:inherit;text-align:center;"
}, {
kind: "enyo.RichText",
name: "secondEntry_1",
content: "",
...
this.$.secondEntry_1.setContent(e.getValue());
},
itemComplete: function(e, t) {
this.item_complete_1 = !this.item_complete_1, this.item_complete_1 ? enyo.log("itemComplete == true") : enyo.log("itemComplete == false"), this.$.secondEntry_1.addRemoveClass("task-now-complete", this.item_complete_1), this.$.secondEntry_1_checkmark.addRemoveClass("checkmark-now-complete", this.item_complete_1);
}
});
